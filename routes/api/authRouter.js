...
const {signUpJoiSchema, loginJoiSchema, verificationEmailSchema} = require ('../../models/user');
...
router.get("/verify/:verificationToken", authenticate, ctrl.varifyMail);
router.post("/verify", validation(verificationEmailSchema), ctrl.varifyMailConfirmation)
